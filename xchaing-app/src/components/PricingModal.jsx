...
const plans = [
  ...
  },
  {
    ...
    price: "$10",
    period: "/თვე",
    description: "პირველი 10 განცხადება უფასოდ, შემდეგ 1.00 ₾ თითო განცხადებაზე.",
    icon: Crown,
    features: ["პირველი 10 განცხადება: 0 ₾", "AI შეფასება და აღწერის გენერატორი", "მე-11-დან: 1.00 ₾ თითო განცხადებაზე"],
  },
];
